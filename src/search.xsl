...
<xsl:template match="item">
  ...
  &lt;div class="searchResult">
    ...
    &lt;a href=&quot;<xsl:value-of select="concat('http://web.archive.org/',archive:collection,'/',date,'/',link)" /> &quot;><xsl:value-of select="title" />&lt;/a>
    &lt;/h1>
    &lt;div>
    ...
    &lt;/div>
    &lt;div class="dates">
      <xsl:text>&lt;a</xsl:text><xsl:text> href=&quot;</xsl:text><xsl:value-of select="concat('http://web.archive.org/',archive:collection,'/*/',link)" /><xsl:text>&quot;</xsl:text><xsl:text>></xsl:text>
